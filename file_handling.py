...
################################################################################################################
        ...
        self.dataframe_managing_label = tk.Label(self.dataframe_managing_subframe, text="List of Available Data Files", font=styles.main_content_header_font, bg=color_dict["sub_frame_bg"], fg=color_dict["main_content_header"])
        ...
        self.open_file_button = ttk.Button(self.button_frame, text="Open New File", command=self.open_file, style="main_content_button.TButton")
        self.open_file_button.pack(side=tk.LEFT, padx=10, pady=10)

        self.change_dataframe_button = ttk.Button(self.button_frame, text="Change to Selected Dataframe", command=self.update_dataframe, style="main_content_button.TButton")
...
################################################################################################################
        ...
        self.dataframe_selection_label = tk.Label(self.dataframe_selection_subframe, text="Choose a Dataframe to Use", font=styles.main_content_header_font, bg=color_dict["sub_frame_bg"], fg=color_dict["main_content_header"])
...
################################################################################################################
        ...
        self.variable_selection_subframe_label = tk.Label(self.variable_selection_subframe, text="Variable Selection", font=styles.main_content_header_font, bg=color_dict["sub_frame_bg"], fg=color_dict["main_content_header"])
...
################################################################################################################
        ...
        self.dataframe_name_frame_subframe_label = tk.Label(self.dataframe_name_frame_subframe, text="Name of New Dataframe:", font=styles.main_content_header_font, bg=color_dict["sub_frame_bg"], fg=color_dict["main_content_header"])
...
################################################################################################################
        ...
        self.condition_options_subframe_label = tk.Label(self.condition_options_subframe, text="Settings", font=styles.main_content_header_font, bg=color_dict["sub_frame_bg"], fg=color_dict["main_content_header"])
...
################################################################################################################
        ...
        # MENU FRAME
        self.dataframe_settings_menu_frame = tk.Frame(self.dataframe_settings_frame, bg='lightgray')
